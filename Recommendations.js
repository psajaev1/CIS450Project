	...
	fetch("http://localhost:8081/recommendations/" + this.state.movieName, {
      ...
      .then(movieList => {
        ...
        let movieDivs = movieList.map((movieObj, i) =>
           <RecommendationsRow airport={movieObj.airport} city={movieObj.city}/>
        ); 
			    ...
			    <div className="container recommendations-container">
			    	<div className="jumbotron">
			    		...
			    		<div className="input-container">
			    			<input type='text' placeholder="Enter Country" value={this.state.movieName} onChange={this.handleMovieNameChange} id="movieName" className="movie-input"/>
